...
for st = 1:6
    ...
    %            13 'per1-sem1','per1-sem1','per1-per2','per1-per2','per1-lex1','per1-lex2',...
    %             19'per2-sem1','per2-sem2','per2-per2','per2-per2','per2-lex1','per2-lex2',...
    %             25'lex1-sem1','lex1-lex1','lex1-per1','lex1-per2','lex1-lex1','lex1-lex2',...
    %             31'lex2-sem1','lex2-lex2','lex2-per1','lex2-per2','lex2-lex1','lex2-lex2'};
