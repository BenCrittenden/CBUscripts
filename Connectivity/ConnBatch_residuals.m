...
rDir = '/imaging/bc01/Experiments4_5/Nov_2012/Experiment_4/Smoothed/SM_Tasks_with_residuals';

BATCH.filename = fullfile(hDir,'Rest_residuals2.mat');
...
for cSub = 1:length(SubNames)
    ...
    for cSess = 1:nSess
        ...
        %Get data
        useDir = fullfile(rDir,SubNames{cSub});
