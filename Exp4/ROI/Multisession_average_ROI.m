...
fn = '/imaging/bc01/Experiments4_5/Nov_2012/Experiment_4/ROI/DM_Tasks_ROIres/roi_betas1.txt';
fsave = '/imaging/bc01/Experiments4_5/Nov_2012/Experiment_4/ROI/DM_Tasks_ROIres/roi_betas1_sorted_means.txt';
...
for curr_roi = 1:num_rois
   ...
   roi_name = roishort{curr_roi};
    ...
    for curr_regressor = 1:num_regressors
        ...
        temp = [temp (eval([roi_name num2str(curr_sess) '_' regressor_name]))];
        ...
        create_variable = [roi_name '_' regressor_name];
           
        %create variable from string
        All_results_ticker = All_results_ticker+1;
        All_results(:,All_results_ticker) = temp_mean;
